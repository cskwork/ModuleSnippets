...
// JSON LIST 객체 고유 키값 조회
function getDistinctJsonListKeys(){
	const list = [
	  { "2022-1학기": "1" },
	  { "2022-2학기": "2" },
	  { "2023-1학기": "3" },
	...
	const distinctKeys = Array.from(new Set(list.map(obj => Object.keys(obj)[0])));
	console.log(distinctKeys); // Output: ['2022-1학기', '2022-2학기', '2023-1학기', '2023-2학기']	
}
